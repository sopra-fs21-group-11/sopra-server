...
public class NCoordinateCategory implements ValueCategory {
    ...
    public boolean isPlacementCorrect(Card referenceCard, Card cardInQuestion) throws Exception {
        ...
        float referenceValue = referenceCard.getNsCoordinates();//we can assign it directly since every card obj has coordinates...
        float questionValue = cardInQuestion.getNsCoordinates();
